//
//  ComercialInformalStepFourViewController.swift
//  C60S
//
...
class ComercialInformalStepFourViewController: BaseViewController, UITableViewDataSource, UITableViewDelegate, MonthlyIncomeDelegate {
    ...
    override func viewDidLoad() {
        ...
        SCSRequests().setTracker(id: 33, orgid: 1, typeid: 33){
            s in print("RESPUESTA EN TRACKER PANTALLA 33 ####### \(s)")
        }
    }
